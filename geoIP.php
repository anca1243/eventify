...
function getLocation() { 
  ...
  $locations = file_get_contents("https://api.ipinfodb.com/v3/ip-city/?key=32de137900caa0fa4c55e85859b44231c1f60112d0b143e0db33248e40553450&ip=".$_SERVER['REMOTE_ADDR']);
  echo $locations;
